...
- 🔭 **GraphHub**（GitHub フォロー関係ビジュアライザー）と **[vscode-view-charset](https://marketplace.visualstudio.com/items?itemName=long-kudo.vscode-view-charset)**（VSCode 拡張機能）を開発中
- ✍️ [Zenn](https://zenn.dev/long910) とブログ [910.jp](https://910.jp/) に技術記事を執筆中
- 🦀 **Rust** とオープンソース活動を探求中
- ⚡ 競技プログラミング（C/C++）と Chrome 拡張機能開発も
